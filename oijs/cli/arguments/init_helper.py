...
"""
module oijs.cli.arguments.init_helper
"""
...
def init_exit(sub_arg):
    ...
    sub_arg.add_parser('exit', help='exit OIJS')
...
def init_help(sub_arg):
    ...
    sub_arg.add_parser('help', help='show this help message')
...
def init_init(sub_arg):
    ...
    cur_parser.add_argument(
        'init_type', help='The type of the project', choices=['problem'])
    cur_parser.add_argument(
